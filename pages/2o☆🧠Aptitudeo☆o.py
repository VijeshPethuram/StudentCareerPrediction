...
st.title("Aptitude🤔💭")
with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//logi.txt", 'r') as file:
    one_line = file.readline()
if(one_line=='0'):
    logical_questions = logical_questions.copy()
    random.shuffle(logical_questions)
    with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//randomized_logical_questions.pkl", "wb") as f:
        pickle.dump(logical_questions, f)
    with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//randomized_logical_questions.pkl", "rb") as f:
        logical_questions = pickle.load(f)
    with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//randomized_logical_questions.pkl", 'w') as file:
        file.write("1")
else:
        with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//randomized_logical_questions.pkl", "rb") as f:
            logical_questions = pickle.load(f)
...
st.markdown('--------------------')
st.header('🧠QUESTIONS ON MEMORY CAPABLITY!!!')
user_responses4 = {}
    
st.title("Quiz on Memory capablity")
...
for i in range(6):
    ...
    st.write(question_data["question"])
        ...
        # Display multiple choice options and store user's choice with a unique key
    user_response4 = st.radio(f"Select an option {i}:", question_data["options"], key=f"radio_mc_{i}")
...
for i in range(5):
    ...
    st.write(question_data["question"])
        ...
        # Display multiple choice options and store user's choice with a unique key
    user_response7 = st.radio(f"Select an option {i}:", question_data["options"], key=f"radio_gr_{i}")
...
if st.button("Submit "):
    with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//logi.txt", 'w') as file:
        file.write("0")   
    ...
    with open("C://Users//Vijesh Pethuram K//OneDrive//Desktop//multipage//result.txt", 'w') as file1:
